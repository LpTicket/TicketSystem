        ...
        <>
          ...
          <section className="premium-section-card overflow-hidden bg-white/95 shadow-sm">
            ...
            <div className="grid grid-cols-1 gap-3 p-5 sm:grid-cols-2 xl:grid-cols-5">
              ...
              <div className="financial-tone-rose rounded-xl border border-rose-400/35 bg-rose-500/15 p-4"><p className="financial-card-label text-[11px] font-black uppercase tracking-wider text-rose-300">Klarna</p><p className="financial-card-value mt-1 text-2xl font-black text-rose-300">{summary.financial.klarnaOrders}</p><p className="financial-card-note mt-1 text-xs font-medium text-rose-100/65">${summary.financial.klarnaTotalCharged.toFixed(2)} {lang === 'es' ? 'cobrados con Klarna' : 'charged with Klarna'}</p></div>
              <div className="financial-tone-amber rounded-xl border border-amber-400/35 bg-amber-500/15 p-4"><p className="financial-card-label text-[11px] font-black uppercase tracking-wider text-amber-300">{lang === 'es' ? 'Ajuste al organizador' : 'Organizer adjustment'}</p><p className="financial-card-value mt-1 text-2xl font-black text-amber-300">-${summary.financial.organizerProcessingAdjustments.toFixed(2)}</p><p className="financial-card-note mt-1 text-xs font-medium text-amber-100/65">{lang === 'es' ? 'Costo adicional real de Klarna' : 'Actual additional Klarna cost'}</p></div>
              ...
              <div className="financial-tone-emerald rounded-xl border border-emerald-400/35 bg-emerald-500/15 p-4"><p className="financial-card-label text-[11px] font-black uppercase tracking-wider text-emerald-300">{lang === 'es' ? 'Conciliación' : 'Reconciliation'}</p><p className="financial-card-value mt-1 text-2xl font-black text-emerald-300">{summary.financial.pendingFeeReconciliations}</p><p className="financial-card-note mt-1 text-xs font-medium text-emerald-100/65">{lang === 'es' ? 'órdenes esperando costo real' : 'orders awaiting actual cost'}</p></div>
            </div>
