    ...
    TypeOrmModule.forRootAsync({
      ...
      useFactory: (config: ConfigService) => {
        ...
        return {
          ...
          entities: [MarketingBanner, PushToken, EmailCampaign, EmailCampaignRecipient, MarketingIntegration, AnalyticsPageView, User, Event, VenueSection, Seat, Order, Ticket, EventCategoryEntity, PaymentMethod, VenueTemplate, SocialMatchPreference, SocialMatchConnection, SocialMatchMessage, SpecialCode, SpecialCodePayout, OrganizerPayout, ScannerAccess],
          synchronize: true,
          logging: false,
