...
const cartSt = StyleSheet.create({
  ...
  emptyTitle: { color: '#F8FAFC', fontSize: 19, lineHeight: 24, fontWeight: '700', textAlign: 'center', marginTop: 2 },
  ...
  emptyActionText: { color: '#F97316', fontSize: 12, fontWeight: '900', letterSpacing: 0.4 },
