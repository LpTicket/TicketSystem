...
const styles = StyleSheet.create({
  ...
  formTitle: { color: '#F8FAFC', fontSize: 14, fontWeight: '600', marginBottom: 12 },
  ...
  typeBtnText: { color: 'rgba(226,232,240,0.6)', fontSize: 12, fontWeight: '600' },
  typeBtnTextActive: { color: '#F97316' },
  row2: { flexDirection: 'row', gap: 10 },
  flex1: { flex: 1 },
  field: { marginBottom: 10 },
  fieldLabel: { color: 'rgba(226,232,240,0.6)', fontSize: 11, fontWeight: '600', letterSpacing: 0.5, marginBottom: 5, textTransform: 'uppercase' },
  fieldInput: {
  ...
  cancelBtnText: { color: '#F8FAFC', fontSize: 13, fontWeight: '600' },
  ...
  methodBrand: { color: '#F8FAFC', fontSize: 14, fontWeight: '600' },
