...
const styles = StyleSheet.create({
  ...
  cardLabel: { color: colors.orange, fontSize: 11, letterSpacing: 0, fontWeight: '600', marginBottom: 12 },
  emptyWrap: { paddingVertical: 24, alignItems: 'center' },
  emptyTitle: { color: '#F8FAFC', fontSize: 16, fontWeight: '600', marginTop: 12, marginBottom: 6 },
  ...
  statValue: { color: '#F8FAFC', fontSize: 20, fontWeight: '600', marginBottom: 2 },
  statLabel: { color: 'rgba(226,232,240,0.64)', fontSize: 11, fontWeight: '600', textTransform: 'uppercase' },
  row: {
    flexDirection: 'row',
  ...
  codeText: { color: colors.orange, fontSize: 18, fontWeight: '600', fontFamily: 'monospace' },
  ...
  payoutEvent: { color: '#F8FAFC', fontSize: 14, fontWeight: '600', marginBottom: 10 },
  payoutStats: { flexDirection: 'row', justifyContent: 'space-between' },
  payoutStat: { flex: 1 },
  payoutStatLabel: { color: 'rgba(226,232,240,0.64)', fontSize: 10, fontWeight: '600', textTransform: 'uppercase', marginBottom: 2 },
  payoutStatValue: { color: '#F8FAFC', fontSize: 15, fontWeight: '600' },
  ...
  saleCode: { color: colors.orange, fontSize: 13, fontWeight: '600', fontFamily: 'monospace' },
  saleEvent: { color: 'rgba(226,232,240,0.64)', fontSize: 11, marginTop: 2, maxWidth: 200 },
  saleRight: { alignItems: 'flex-end' },
  saleTotal: { color: '#F8FAFC', fontSize: 14, fontWeight: '600' },
