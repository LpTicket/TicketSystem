...
const styles = StyleSheet.create({
  ...
  copy: { color: '#cbd5e1', fontSize: 13, lineHeight: 19, fontWeight: '700' },
  card: {
    backgroundColor: 'rgba(255,255,255,0.018)',
    borderRadius: 24,
    borderWidth: 1,
  ...
  eventMeta: { color: 'rgba(226,232,240,0.64)', fontSize: 12, fontWeight: '700' },
  ...
  activationSub: { color: 'rgba(226,232,240,0.52)', fontSize: 12, fontWeight: '700' },
  ...
  toggleSub: { color: 'rgba(226,232,240,0.64)', fontSize: 12, lineHeight: 17, fontWeight: '700' },
  ...
  summaryText: { color: '#F8FAFC', fontSize: 14, lineHeight: 22, fontWeight: '800' },
  suggestionCard: {
    borderRadius: 20,
    borderWidth: 1,
    borderColor: 'rgba(255,255,255,0.14)',
  ...
  suggestionMeta: { color: 'rgba(226,232,240,0.64)', fontSize: 12, fontWeight: '700', marginBottom: 7 },
  ...
  connectionMeta: { color: 'rgba(226,232,240,0.64)', fontSize: 11, fontWeight: '700' },
  ...
  messageText: { color: '#F8FAFC', fontSize: 13, fontWeight: '700', lineHeight: 18 },
  ...
  emptyCopy: { color: 'rgba(226,232,240,0.64)', fontSize: 14, fontWeight: '700', textAlign: 'center', lineHeight: 21 },
});
