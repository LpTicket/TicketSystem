...
const styles = StyleSheet.create({
  ...
  scanIconText: { color: colors.textPrimary, fontSize: 38, fontWeight: '900' },
  ...
  statusLabel: { color: colors.textFaint, fontSize: 12, fontWeight: '800', textAlign: 'center', marginTop: 4 },
  notice: { backgroundColor: '#fff7ed', borderRadius: 20, borderWidth: 1, borderColor: '#FED7AA', padding: 15, marginBottom: 14 },
  noticeTitle: { color: colors.textPrimary, fontSize: 16, fontWeight: '900', marginBottom: 5 },
