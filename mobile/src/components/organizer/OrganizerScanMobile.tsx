...
const styles = StyleSheet.create({
  ...
  title: { color: colors.textPrimary, fontSize: 26, fontWeight: '600', marginBottom: 8 },
  ...
  scanIconText: { color: colors.textPrimary, fontSize: 38, fontWeight: '600' },
  scanTitle: { color: '#FFFFFF', fontSize: 24, fontWeight: '600', marginBottom: 8, textAlign: 'center' },
  scanCopy: { color: '#cbd5e1', fontSize: 14, fontWeight: '600', textAlign: 'center', lineHeight: 21 },
  ...
  statusValue: { color: colors.orange, fontSize: 22, fontWeight: '600', textAlign: 'center' },
  statusLabel: { color: colors.textFaint, fontSize: 12, fontWeight: '600', textAlign: 'center', marginTop: 4 },
