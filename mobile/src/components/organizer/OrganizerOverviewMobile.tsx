...
const styles = StyleSheet.create({
  ...
  secTitle: { color: '#F8FAFC', fontSize: 16, fontWeight: '600', marginBottom: 10 },
  row: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingVertical: 4 },
  k: { color: 'rgba(203,213,225,0.7)', fontSize: 13, fontWeight: '600' },
  v: { color: '#F8FAFC', fontSize: 13, fontWeight: '600', textTransform: 'capitalize' },
  price: { color: '#F97316', fontSize: 18, fontWeight: '600', marginTop: 8 },
