...
const styles = StyleSheet.create({
  ...
  quickTitle: { color: colors.navy, fontSize: 16, fontWeight: '900', marginBottom: 4 },
  quickCopy: { color: '#6B7280', fontSize: 12, lineHeight: 18, fontWeight: '700' },
  ...
  sectionTitle: { color: colors.navy, fontSize: 18, fontWeight: '900', marginTop: 10, marginBottom: 12 },
  accessCard: {
    backgroundColor: '#FFFFFF',
    borderRadius: 22,
    borderWidth: 1,
  ...
  accessMain: { flex: 1 },
  accessTitle: { color: colors.navy, fontSize: 17, fontWeight: '900', marginBottom: 4 },
  accessType: { color: '#6B7280', fontSize: 13, fontWeight: '700' },
  ...
  secondaryText: { color: colors.navy, fontSize: 11, letterSpacing: 1.3, fontWeight: '900' },
});
