...
const styles = StyleSheet.create({
  ...
  scannerAccessEyebrow: { color: colors.orange, fontSize: 10, fontWeight: '600', letterSpacing: 0.7 },
  scannerAccessTitle: { color: colors.text, fontSize: 17, fontWeight: '600', marginTop: 4 },
  ...
  scannerRequestName: { color: colors.text, fontSize: 13, fontWeight: '600' },
  ...
  blockedEyebrow: { color: colors.orange, fontSize: 11, fontWeight: '600', letterSpacing: 0.8 },
  ...
  toolBtnText: { color: colors.text, fontSize: 12, fontWeight: '600' },
  ...
  seatRow: { color: colors.muted, fontSize: 8, fontWeight: '600' },
  seatNum: { color: colors.text, fontSize: 12, fontWeight: '600' },
  ...
  actionTitle: { color: colors.text, fontSize: 12, fontWeight: '600', textTransform: 'uppercase', letterSpacing: 0.5 },
  ...
  blockBtnText: { color: '#F59E0B', fontSize: 12, fontWeight: '600' },
  input: {
