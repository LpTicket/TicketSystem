...
const styles = StyleSheet.create({
  ...
  copy: { color: '#6B7280', fontSize: 15, lineHeight: 22, fontWeight: '400', marginBottom: 16 },
  ...
  fieldCompact: { flex: 1 },
  fieldLabel: { color: '#6B7280', fontSize: 12, letterSpacing: 1.4, fontWeight: '400', textTransform: 'uppercase', marginBottom: 8 },
