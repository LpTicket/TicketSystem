...
const styles = StyleSheet.create({
  ...
  eyebrow: { color: '#F97316', fontSize: 11, fontWeight: '600', letterSpacing: 0.8 },
  headerTitle: { color: '#F8FAFC', fontSize: 20, fontWeight: '600', marginTop: 4 },
  ...
  exportText: { color: '#F97316', fontSize: 12, fontWeight: '600' },
  ...
  statLabel: { color: 'rgba(203,213,225,0.7)', fontSize: 11, fontWeight: '600', textTransform: 'uppercase', flex: 1 },
  statIcon: { width: 30, height: 30, borderRadius: 10, alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(249,115,22,0.12)' },
  statValue: { color: '#F8FAFC', fontSize: 24, fontWeight: '600', marginTop: 8 },
