...
const styles = StyleSheet.create({
  ...
  eventTitle: { color: colors.textPrimary, fontSize: 21, fontWeight: '900', lineHeight: 26, marginBottom: 5 },
  ...
  miniValue: { color: colors.textPrimary, fontSize: 16, fontWeight: '900', textAlign: 'center' },
