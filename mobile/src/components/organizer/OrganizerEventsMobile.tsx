...
const styles = StyleSheet.create({
  ...
  copy: { color: '#cbd5e1', fontSize: 14, lineHeight: 21, fontWeight: '700', marginBottom: 16 },
  createButton: {
    height: 50,
    borderRadius: 16,
  ...
  eventMeta: { color: '#6B7280', fontSize: 13, lineHeight: 19, fontWeight: '700' },
  ...
  miniLabel: { color: '#6B7280', fontSize: 11, fontWeight: '800', textAlign: 'center', marginTop: 3 },
