  ...
  return (
    <ScrollView style={styles.screen} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.heroWrap}>
        ...
        <Animated.Image source={getHeroImageSource(nextHeroEvent)} style={[styles.heroImage, styles.heroImageOverlay, { opacity: fadeAnim }]} resizeMode="cover" />
...
const styles = StyleSheet.create({
  ...
  orangeButtonTop: { position: 'absolute', top: 1, left: 1, right: 1, height: '46%', borderTopLeftRadius: 7, borderTopRightRadius: 7, backgroundColor: 'rgba(255,210,150,0.13)', zIndex: 1 },
  orangeButtonBottom: { position: 'absolute', left: 1, right: 1, bottom: 1, height: '58%', borderBottomLeftRadius: 7, borderBottomRightRadius: 7, backgroundColor: 'rgba(154,52,18,0.12)', zIndex: 1 },
  ...
  bgAccentOrange: { position: 'absolute', left: -140, top: -120, width: 380, height: 380, borderRadius: 190, backgroundColor: 'rgba(249,115,22,0.07)' },
  bgAccentBlue: { position: 'absolute', right: -150, top: -80, width: 400, height: 400, borderRadius: 200, backgroundColor: 'rgba(56,189,248,0.06)' },
  ...
  content: { paddingBottom: 46, backgroundColor: '#030B14' },
  heroWrap: { marginHorizontal: 16, marginTop: 18, marginBottom: 0, height: 340, overflow: 'hidden', backgroundColor: '#081F33', borderWidth: 1, borderColor: 'rgba(246,198,95,0.14)', borderRadius: 14, shadowColor: '#000000', shadowOpacity: 0.24, shadowRadius: 20, shadowOffset: { width: 0, height: 10 }, elevation: 5 },
  ...
  heroArrow: { position: 'absolute', top: '48%', width: 44, height: 44, borderRadius: 10, borderWidth: 1, borderColor: 'rgba(255,255,255,0.18)', backgroundColor: 'rgba(255,255,255,0.025)', alignItems: 'center', justifyContent: 'center' },
  heroLeft: { left: 14 },
  heroRight: { right: 14 },
  ...
  fieldLabel: { color: 'rgba(255,255,255,0.86)', fontSize: 10, fontWeight: '400', letterSpacing: 2.1, marginBottom: 8 },
  ...
  searchButton: { height: 58, borderRadius: 8, position: 'relative', overflow: 'hidden', backgroundColor: '#F97316', borderWidth: 1, borderColor: 'rgba(251,146,60,0.62)', borderTopColor: 'rgba(253,186,116,0.76)', alignItems: 'center', justifyContent: 'center' },
  searchText: { color: '#FFFFFF', fontWeight: '700', letterSpacing: 4, fontSize: 13, zIndex: 3 },
  ...
  categoryText: { color: '#E5E7EB', fontSize: 14, fontWeight: '400' },
  ...
  sortButton: { height: 58, borderRadius: 8, marginBottom: 8, position: 'relative', overflow: 'hidden', backgroundColor: '#F97316', borderWidth: 1, borderColor: 'rgba(251,146,60,0.62)', borderTopColor: 'rgba(253,186,116,0.76)', alignItems: 'center', justifyContent: 'center' },
  sortText: { color: '#FFFFFF', fontWeight: '700', letterSpacing: 3.4, fontSize: 12, zIndex: 3 },
  ...
  buyButton: { flex: 1, height: 56, borderRadius: 8, position: 'relative', overflow: 'hidden', backgroundColor: '#F97316', borderWidth: 1, borderColor: 'rgba(251,146,60,0.62)', borderTopColor: 'rgba(253,186,116,0.76)', alignItems: 'center', justifyContent: 'center' },
  buyText: { color: '#FFFFFF', fontSize: 13, fontWeight: '700', letterSpacing: 2.2, zIndex: 3 },
});
