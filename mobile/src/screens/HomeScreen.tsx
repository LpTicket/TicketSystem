...
const styles = StyleSheet.create({
  ...
  content: { paddingTop: 33, paddingBottom: 46, backgroundColor: 'transparent' },
  heroWrap: { width: '100%', marginHorizontal: 0, marginTop: 14, marginBottom: 12, aspectRatio: 2.63, overflow: 'hidden', backgroundColor: 'rgba(2,8,15,0.42)', borderTopWidth: 0, borderBottomWidth: 0, borderColor: 'transparent', borderRadius: 0, alignItems: 'center', justifyContent: 'center', shadowColor: '#000000', shadowOpacity: 0.30, shadowRadius: 24, shadowOffset: { width: 0, height: 12 }, elevation: 6 },
  heroImage: { width: '100%', height: '100%', backgroundColor: 'transparent' },
  heroArrow: { position: 'absolute', top: '50%', transform: [{ translateY: -22 }], width: 44, height: 44, borderRadius: 12, borderWidth: 1, borderColor: 'rgba(255,255,255,0.22)', backgroundColor: 'rgba(70,70,75,0.55)', alignItems: 'center', justifyContent: 'center', zIndex: 10, elevation: 10 },
  heroLeft: { left: 14 },
  heroRight: { right: 14 },
