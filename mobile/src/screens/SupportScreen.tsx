...
const styles = StyleSheet.create({
  ...
  pillText: { color: '#F97316', fontSize: 11, fontWeight: '600', letterSpacing: 1.2, textTransform: 'uppercase' },
  title: { color: '#F8FAFC', fontSize: 30, lineHeight: 34, fontWeight: '600', textAlign: 'center' },
  ...
  catLabel: { color: 'rgba(203,213,225,0.6)', fontSize: 12, fontWeight: '600' },
  ...
  faqQ: { color: '#F8FAFC', fontSize: 15, fontWeight: '600', flex: 1, lineHeight: 20 },
  ...
  helpTitle: { color: '#F8FAFC', fontSize: 18, fontWeight: '600', marginBottom: 6 },
