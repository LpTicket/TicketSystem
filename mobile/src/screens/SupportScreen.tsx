...
const styles = StyleSheet.create({
  ...
  hero: { alignItems: 'center', marginBottom: 20, marginTop: 6, gap: 12 },
  pill: { flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: 'rgba(249,115,22,0.12)', borderRadius: 999, paddingHorizontal: 12, paddingVertical: 6 },
  pillText: { color: '#F97316', fontSize: 11, fontWeight: '800', letterSpacing: 1.2, textTransform: 'uppercase' },
  title: { color: '#FFFFFF', fontSize: 30, lineHeight: 34, fontWeight: '900', textAlign: 'center' },
  ...
  emptyFaq: { padding: 22, borderRadius: 14, borderWidth: 1, borderColor: 'rgba(255,255,255,0.1)', backgroundColor: 'rgba(255,255,255,0.03)', alignItems: 'center', marginBottom: 10 },
  emptyText: { color: 'rgba(203,213,225,0.7)', fontSize: 14 },
  helpCard: { marginTop: 6, backgroundColor: 'rgba(8,31,51,0.82)', borderRadius: 16, borderWidth: 1, borderColor: 'rgba(249,115,22,0.28)', padding: 20 },
  helpTitle: { color: '#FFFFFF', fontSize: 18, fontWeight: '900', marginBottom: 6 },
  helpCopy: { color: 'rgba(203,213,225,0.7)', fontSize: 14, lineHeight: 20, marginBottom: 16 },
