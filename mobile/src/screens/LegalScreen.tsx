...
const styles = StyleSheet.create({
  ...
  heading: { color: '#F8FAFC', fontSize: 16, fontWeight: '800', marginTop: 22, marginBottom: 10, paddingBottom: 8, borderBottomWidth: 1, borderBottomColor: 'rgba(255,255,255,0.10)' },
