...
const styles = StyleSheet.create({
  ...
  progressTrack: { height: 10, borderRadius: 999, backgroundColor: '#E5E7EB', marginVertical: 14, overflow: 'hidden' },
  progressFill: { width: '24%', height: '100%', backgroundColor: colors.orange },
  eventCard: { backgroundColor: '#FFFFFF', borderRadius: 24, borderWidth: 1, borderColor: '#E5E7EB', padding: 18, marginBottom: 14 },
  ...
  mapPreview: { height: 230, backgroundColor: '#F8FAFC', borderRadius: 20, borderWidth: 1, borderColor: '#E5E7EB', marginTop: 8, marginBottom: 16, position: 'relative', overflow: 'hidden' },
  ...
  listCard: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 12, backgroundColor: '#F8FAFC', borderRadius: 16, borderWidth: 1, borderColor: '#E5E7EB', padding: 14, marginTop: 10 },
  listTitle: { color: colors.navy, fontSize: 16, fontWeight: '900' },
  listSub: { color: '#6B7280', fontSize: 13, fontWeight: '600', marginTop: 3 },
