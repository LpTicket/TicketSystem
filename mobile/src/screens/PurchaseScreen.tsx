...
export function PurchaseScreen({ event, onBack, onContinue }: Props) {
  ...
  return (
    <View style={styles.screen}>
      ...
      <Text style={styles.title}>Select your tickets</Text>
      <Text style={styles.subtitle}>{event.title}</Text>

      <View style={styles.ticketType}>
        <View>
          <Text style={styles.typeLabel}>GENERAL ACCESS</Text>
          <Text style={styles.typeName}>Standard ticket</Text>
      ...
      <View style={styles.summary}>
        ...
        <View style={styles.row}><Text style={styles.rowLabel}>Tickets</Text><Text style={styles.rowValue}>${subtotal.toFixed(2)}</Text></View>
        <View style={styles.row}><Text style={styles.rowLabel}>Service fee</Text><Text style={styles.rowValue}>${service.toFixed(2)}</Text></View>
...
const styles = StyleSheet.create({
  ...
  ticketType: { backgroundColor: colors.white, borderRadius: 22, borderWidth: 1, borderColor: colors.border, padding: 18, flexDirection: 'row', justifyContent: 'space-between', gap: 16 },
  ...
  qtyCard: { marginTop: 16, backgroundColor: colors.white, borderRadius: 22, borderWidth: 1, borderColor: colors.border, padding: 18, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  ...
  summary: { marginTop: 16, backgroundColor: colors.white, borderRadius: 22, borderWidth: 1, borderColor: colors.border, padding: 18 },
  ...
  divider: { height: 1, backgroundColor: '#E5EAF0', marginVertical: 8 },
  totalLabel: { color: colors.navy, fontSize: 18, fontWeight: '800' },
  totalValue: { color: colors.orange, fontSize: 22, fontWeight: '800' },
  continueButton: { marginTop: 18, height: 56, borderRadius: 14, backgroundColor: colors.orange, alignItems: 'center', justifyContent: 'center' },
