...
const styles = StyleSheet.create({
  ...
  eyebrow: { color: '#F97316', fontSize: 12, fontWeight: '600', letterSpacing: 0 },
  title: { color: '#F8FAFC', fontSize: 32, lineHeight: 36, fontWeight: '600', marginTop: 10 },
  ...
  emptyTitle: { color: '#F8FAFC', fontSize: 22, fontWeight: '600' },
  ...
  ticketInfo: { flex: 1 },
  ticketEyebrow: { color: '#F97316', fontSize: 11, fontWeight: '600', letterSpacing: 0 },
  eventTitle: { color: '#F8FAFC', fontSize: 26, lineHeight: 31, fontWeight: '600', marginTop: 8 },
  ...
  statusText: { fontSize: 11, fontWeight: '600', letterSpacing: 0 },
  ...
  qrFallbackText: { color: '#FFFFFF', fontSize: 28, fontWeight: '600' },
  ...
  detailLabel: { color: 'rgba(226,232,240,0.48)', fontSize: 10, fontWeight: '600', letterSpacing: 0 },
  detailValue: { color: '#F8FAFC', fontSize: 14, fontWeight: '600', marginTop: 3 },
  ...
  actionText: { color: '#F8FAFC', fontSize: 11, fontWeight: '600', letterSpacing: 0, textAlign: 'center' },
