...
const styles = StyleSheet.create({
  ...
  stopText: { color: '#FFFFFF', fontSize: 10, fontWeight: '900', letterSpacing: 1.6 },
  ...
  detailValueFeatured: { color: '#FFFFFF', fontSize: 13, fontWeight: '900' },
  ...
  statsTitle: { color: '#FFFFFF', fontSize: 22, fontWeight: '900', marginTop: 6 },
  ...
  resetText: { color: '#CBD5E1', fontSize: 10, fontWeight: '900', letterSpacing: 1.2 },
  ...
  statValue: { color: '#FFFFFF', fontSize: 32, fontWeight: '900', marginTop: 6 },
  ...
  capacityValue: { color: '#FFFFFF', fontSize: 30, fontWeight: '900', marginTop: 4 },
