...
const styles = StyleSheet.create({
  ...
  soundText: { color: '#FFFFFF', fontWeight: '900', fontSize: 11, letterSpacing: 1.2 },
  ...
  badgeIcon: { color: '#FFFFFF', fontSize: 14, fontWeight: '900' },
  badgeText: { color: '#FFFFFF', fontSize: 11, fontWeight: '900', letterSpacing: 2.2 },
  title: { color: '#FFFFFF', fontSize: 30, lineHeight: 34, fontWeight: '900', marginTop: 14 },
  subtitle: { color: 'rgba(226,232,240,0.64)', fontSize: 13, lineHeight: 20, fontWeight: '400', marginTop: 8 },

  scannerCard: { marginTop: 22, borderRadius: 8, borderWidth: 1, borderColor: 'rgba(10,55,90,0.28)', backgroundColor: '#FFFFFF', overflow: 'hidden' },
  startPanel: { minHeight: 250, alignItems: 'center', justifyContent: 'center', padding: 24 },
  ...
  stopButton: { position: 'absolute', bottom: 14, alignSelf: 'center', borderRadius: 8, backgroundColor: '#FFFFFF', paddingHorizontal: 18, paddingVertical: 10 },
  stopText: { color: '#0A375A', fontSize: 10, fontWeight: '900', letterSpacing: 1.6 },
  ...
  orangeButtonText: { color: '#FFFFFF', fontSize: 12, fontWeight: '900', letterSpacing: 2.0, zIndex: 2 },
  ...
  statusEyebrow: { color: 'rgba(226,232,240,0.58)', fontSize: 11, fontWeight: '900', letterSpacing: 1.8 },
  ...
  separatorText: { color: 'rgba(226,232,240,0.48)', fontSize: 10, fontWeight: '400', letterSpacing: 2.0 },
  ...
  input: { flex: 1, color: '#FFFFFF', fontSize: 14, fontWeight: '900', letterSpacing: 2.0, outlineStyle: 'none' as any },
  blueButton: { minHeight: 56, borderRadius: 8, backgroundColor: '#0A375A', alignItems: 'center', justifyContent: 'center' },
  blueButtonText: { color: '#FFFFFF', fontSize: 12, fontWeight: '900', letterSpacing: 1.6 },
  ...
  validationIconText: { color: '#FFFFFF', fontSize: 42, fontWeight: '900', lineHeight: 46 },
  validationLabel: { color: 'rgba(255,255,255,0.70)', fontSize: 10, fontWeight: '400', letterSpacing: 3.0 },
  validationTitle: { color: '#FFFFFF', fontSize: 24, fontWeight: '900', marginTop: 8, textAlign: 'center' },
  validationCopy: { color: 'rgba(226,232,240,0.66)', fontSize: 13, lineHeight: 20, textAlign: 'center', fontWeight: '400', marginTop: 8 },
  ticketDetails: { alignSelf: 'stretch', marginTop: 18, borderRadius: 8, backgroundColor: 'rgba(255,255,255,0.94)', padding: 14 },
  detail: { flex: 1, minWidth: 0, paddingVertical: 6 },
  detailFeatured: { borderBottomWidth: 1, borderBottomColor: 'rgba(15,23,42,0.08)', marginBottom: 8, paddingBottom: 12 },
  detailGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 12 },
  detailLabel: { color: '#94A3B8', fontSize: 9, fontWeight: '400', letterSpacing: 1.4 },
  detailValue: { color: '#1F2937', fontSize: 12, fontWeight: '400', marginTop: 4 },
  detailValueFeatured: { color: '#0A375A', fontSize: 13, fontWeight: '900' },
  detailValueOrange: { color: '#F97316', fontWeight: '900' },
  ...
  nextButtonText: { color: '#FFFFFF', fontSize: 11, fontWeight: '900', letterSpacing: 1.4 },

  statsPanel: { marginTop: 22, borderRadius: 8, borderWidth: 1, borderColor: 'rgba(226,232,240,0.12)', backgroundColor: 'rgba(255,255,255,0.94)', padding: 16 },
  statsHeader: { flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'space-between', gap: 12 },
  statsEyebrow: { color: '#F97316', fontSize: 10, fontWeight: '900', letterSpacing: 2.6 },
  statsTitle: { color: '#111827', fontSize: 22, fontWeight: '900', marginTop: 6 },
  resetButton: { borderRadius: 8, backgroundColor: '#F1F5F9', paddingHorizontal: 12, paddingVertical: 9 },
  resetText: { color: '#475569', fontSize: 10, fontWeight: '900', letterSpacing: 1.2 },
  statGrid: { marginTop: 16, gap: 10 },
  statCard: { borderRadius: 8, borderWidth: 1, borderColor: 'rgba(10,55,90,0.10)', backgroundColor: '#F8FAFC', padding: 14 },
  ...
  statLabel: { color: '#94A3B8', fontSize: 10, fontWeight: '400', letterSpacing: 1.2 },
  statLabelOrange: { color: '#FB923C' },
  statLabelGreen: { color: '#10B981' },
  statValue: { color: '#0A375A', fontSize: 32, fontWeight: '900', marginTop: 6 },
  statValueOrange: { color: '#F97316' },
  statValueGreen: { color: '#10B981' },
  capacityCard: { marginTop: 10, borderRadius: 8, borderWidth: 1, borderColor: 'rgba(10,55,90,0.18)', backgroundColor: 'rgba(10,55,90,0.06)', padding: 14, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  capacityLabel: { color: 'rgba(10,55,90,0.58)', fontSize: 10, fontWeight: '400', letterSpacing: 1.2 },
  capacityValue: { color: '#0A375A', fontSize: 30, fontWeight: '900', marginTop: 4 },
  capacityPercent: { color: 'rgba(10,55,90,0.62)', fontSize: 24, fontWeight: '900' },

  recentPanel: { marginTop: 22 },
  recentHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 },
  recentTitle: { color: '#FFFFFF', fontSize: 18, fontWeight: '900' },
  ...
  recentMark: { width: 24, height: 24, borderRadius: 12, color: '#FFFFFF', textAlign: 'center', lineHeight: 24, fontWeight: '900' },
  recentMarkValid: { backgroundColor: '#10B981' },
  recentMarkInvalid: { backgroundColor: '#EF4444' },
  recentCopy: { flex: 1, minWidth: 0 },
  recentName: { color: '#FFFFFF', fontSize: 13, fontWeight: '900' },
  recentMeta: { color: 'rgba(226,232,240,0.52)', fontSize: 11, fontWeight: '400', marginTop: 3 },
  recentTime: { color: '#CBD5E1', fontSize: 11, fontWeight: '900' },
});
