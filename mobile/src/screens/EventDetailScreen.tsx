...
const st = StyleSheet.create({
  ...
  gaLabel: { color: colors.orange, fontSize: 10, fontWeight: '600', letterSpacing: 0.5 },
  gaName: { color: colors.textPrimary, fontSize: 17, fontWeight: '600', marginTop: 4 },
  gaMeta: { color: colors.textMuted, fontSize: 12, marginTop: 3 },
  gaPrice: { color: colors.textPrimary, fontSize: 20, fontWeight: '600' },
  ...
  seatRowLabel: { flex: 1, color: 'rgba(226,232,240,0.85)', fontSize: 13, fontWeight: '600' },
  seatRowPrice: { color: '#F8FAFC', fontSize: 13, fontWeight: '600' },
  feeRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  feeLabel: { color: 'rgba(203,213,225,0.65)', fontSize: 13, fontWeight: '500' },
  feeValue: { color: 'rgba(226,232,240,0.85)', fontSize: 13, fontWeight: '600' },
  ...
  totalValue: { color: colors.orange, fontSize: 24, fontWeight: '600' },
  ...
  buyText: { color: '#FFFFFF', fontSize: 15, fontWeight: '600', letterSpacing: 0.4 },
  ...
  trustTitle: { color: '#F8FAFC', fontSize: 13, fontWeight: '600' },
  ...
  zonePrice: { color: '#F8FAFC', fontSize: 13, fontWeight: '600' },
});
