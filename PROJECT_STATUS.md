...
| Mapas, secciones y asientos | IMPLEMENTADO | Editor web/móvil, entidades y endpoints presentes; el editor web permite seleccionar varias secciones y aplicar un precio al grupo o a una seleccionada antes de guardar. Las mesas rectangulares distribuyen automáticamente las sillas de forma simétrica y aumentan su tamaño al añadir sillas, sin reemplazar ajustes manuales existentes. |
