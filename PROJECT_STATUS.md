...
- El desglose nuevo de Klarna en dashboard y Analíticas está implementado localmente y todavía requiere publicación y comprobación con una orden real conciliada.
...
| Panel administrador | IMPLEMENTADO, NO PROBADO EN PRODUCCIÓN | Usuarios, eventos, facturas, marketing, categorías y analítica presentes. El dashboard y Analíticas muestran compras Klarna, compradores recientes, total cobrado, ajuste adicional del organizador y conciliaciones pendientes. El resumen financiero por evento muestra además el monto ya pagado y el saldo exacto pendiente del organizador. El buscador de usuarios consulta todos los registros y el historial administrativo abre las entradas y recibos existentes. Pendiente comprobar visualmente los nuevos bloques con una compra Klarna real conciliada. |
