...
- Móvil `1.0.9`: iOS build 39 terminado en EAS (`fc0fe044-251f-40e6-8faf-749a3cb0df72`) con el refresco silencioso del saldo incluido; envío correcto a TestFlight en cola (`31877ad4-6099-4a88-9053-58eb6fd99263`). Se cancelaron el envío anterior del build 38 y el build redundante 40 para que solo avance la versión correcta. Android build 7 permanece en la cola gratuita (`04941266-f11d-4455-b0df-31cfeee8da8e`). Apple tenía publicada `1.0.8 (37)`; la disponibilidad de `1.0.9 (39)` todavía depende de la carga y procesamiento de Apple.
