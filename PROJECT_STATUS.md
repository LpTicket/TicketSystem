...
| Creación y edición de eventos | IMPLEMENTADO, NO PROBADO | El organizador puede elegir durante la creación web entre mapa visual o entrada general. Entrada general reutiliza la sección standing existente, con nombre, precio y capacidad; no cambia el esquema, pagos, Stripe, móvil ni eventos ya creados. Pendiente prueba manual de creación y compra. |
