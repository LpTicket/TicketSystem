...
| Marketing email, SMS, WhatsApp y push | IMPLEMENTADO, NO PROBADO | Código presente; entrega depende de proveedores externos. Los emails de Marketing incluyen una acción secundaria hacia la app oficial de LPTicket en App Store; pendiente confirmar el enlace desde un correo real. |
